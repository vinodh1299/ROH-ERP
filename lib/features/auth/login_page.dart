    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          _CredRow('Director', AppConstants.directorEmail, AppConstants.directorPassword),
          _CredRow('Therapist', AppConstants.therapistEmail, AppConstants.therapistPassword),
          _CredRow('Parent', AppConstants.parentEmail, AppConstants.parentPassword),
        ],
      ),
    );
  }
